...
The evaluation adopted **Nielsen's 10 usability heuristics** as its protocol, but with a methodological adaptation that adds granularity: each heuristic was broken down into **3 objective questions**, totaling **30 items per application**. Each item received:
